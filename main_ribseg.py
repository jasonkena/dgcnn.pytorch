...
def _init_():
    ...
    os.system('cp main_ribseg.py outputs'+'/'+args.exp_name+'/'+'main_ribseg.py.backup')
...
if __name__ == "__main__":
 ...
 # python main_ribseg.py --exp_name=ribseg_2048_40_32 --num_points=2048 --k=40 --batch_size=32
